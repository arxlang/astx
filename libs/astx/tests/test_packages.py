...
def test_interactive() -> None:
    ...
    interactive.append(decl_a)
    interactive.append(decl_b)
    interactive.append(sum_op)

    assert interactive.get_struct()
    assert interactive.get_struct(simplified=True)

    visualize(interactive.get_struct())
